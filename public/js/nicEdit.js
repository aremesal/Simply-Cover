...
var nicEditorConfig = bkClass.extend({
	...
	iconList : {"xhtml":1,"bold":2,"center":3,"hr":4,"indent":5,"italic":6,"justify":7,"left":8,"ol":9,"outdent":10,"removeformat":11,"right":12,"save":13,"strikethrough":14,"subscript":15,"superscript":16,"ul":17,"underline":18,"image":19,"link":20,"unlink":21,"close":22,"arrow":23,"upload":24}
...
var nicImageButton = nicEditorAdvancedButton.extend({	
	addPane : function() {
		...
		this.addForm({
			...
			'align' : {type : 'select', txt : __('Align'), options : {none : 'Default','left' : 'Left', 'right' : 'Right'}}
		},this.im);
	},
