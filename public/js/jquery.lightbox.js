...
{	// Create our Plugin function, with $ as the argument (we pass the jQuery object over later)
	...
	{	// Our LightboxClass definition
		...
		text: {
			...
			of:			'de',
			close:		'Cerrar',
			closeInfo:	'También puedes cerrar la imagen haciendo clic fuera de la imagen.',
			download:	'Descargar.',
			help: {
				close:		'Clic para cerrar',
				interact:	'Mueve el ratón sobre la imagen para moverte entre todas las imágenes'
			},
			about: {
